...
class ExtrasWindow(ttk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        master.title("Management System\ Extras")
        ...
        ch_pass_frame.place(x=20, y=135, width=930, height=200)
        ...
        current_password_label = ttk.Label(ch_pass_frame, text="Current Password",
                                            font="Arial 17 bold")
        current_password_label.place(x=90, y=40) #
        ...
        self.current_password_entry.place(x=90,y=90)
        ...
        line_label_half.place(x=89, y=135)
        ...
        self.change_password_button.pack(side='bottom', pady=20)


        #===============  THEME Frame / Right Frame 1  ======================

        theme_frame = ttk.Frame(self.bg_frame, border=1)
        theme_frame.place(x=970, y=135, width=350, height=200)
        
        heading_label = ttk.Label(theme_frame, text="CHANGE THEME",
                                 font="Arial 20 bold", foreground='#4eacfe')
        heading_label.pack(side='top', pady=7)
    ...
    def change_password(self):
        ...
        decrypted_password = self.db_obj.get_login_data()[2]
        ...
        if new_password_fetch != "":
            if current_password_fetch == decrypted_password:
                if current_password_fetch == new_password_fetch:
                    ...
                    new_password = new_password_fetch
    ...
    def change_entry(self):
        self.db_obj.change_entry(self.var_entry1.get(),self.var_entry2.get(),self.var_entry3.get(),self.var_entry4.get(),self.var_entry5.get(),self.var_entry6.get())
        tk.messagebox.showinfo("Successful", "Succesfully Changed Entry")
